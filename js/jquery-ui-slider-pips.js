...
// FLOATS
        ...
        float: function( settings ) {
            ...
            var i,
                ...
                tipValues = [],
                $handles = slider.element.find(".ui-slider-handle"),
                $results = $(".slider-container").find("." + slider.element.attr('class').split(' ')[0] + "-result");
            ...
            slider.element
                ...
                .find(".ui-slider-tip, .ui-slider-tip-label, .ui-slider-result")
                .remove();
            ...
            if ( options.handle ) {
                ...
                for( i = 0; i < tipValues.length; i++ ) {
                    ...
                    if ( options.result ) {
                        $results
                            .eq(i)
                            .append($("<span class=\"ui-slider-result num\">" + options.formatLabel(tipValues[i]) + "</span>"));
                    }
                }
            ...
            // when slider changes, update handle tip and result label.
