...
;(function($, window, undefined){
	...
	$(document).ready(function()
	{
		...
		$(".blog-slider, .news-slider, .pressrelease-slider, .video-slider, .wiki-slider, .article-slider")
		...
		//Show/Hide Beat Aggressivenes %
		$('#edit-roadmap').on('shown.bs.modal', function () {
			if ($('#algorithm-radio-match').is(':checked')) {
				$('.algorithm-match .tile-stats')
					.removeClass('animated fadeOut hidden')
					.addClass('animated fadeIn');
			}
			if ($('#algorithm-radio-beat').is(':checked')) {
				$('.algorithm-beat .tile-stats')
					.removeClass('animated fadeOut hidden')
					.addClass('animated fadeIn');
			}
			if ($('#algorithm-radio-evolutionary').is(':checked')) {
				$('.algorithm-evolutionary .tile-stats')
					.removeClass('animated fadeOut hidden')
					.addClass('animated fadeIn');
			}
		});

		$('input[type=radio][name=algorithm-radio]').change(function() {
			console.log(this.value);
			if (this.value == 'match') {
				$('.algorithm-match .tile-stats')
					.removeClass('animated fadeOut hidden')
					.addClass('animated fadeIn');
				$('.algorithm-beat .tile-stats, .algorithm-evolutionary .tile-stats')
					.removeClass('animated fadeIn')
					.addClass('animated fadeOut');
			} else if (this.value == 'beat') {
				$('.algorithm-beat .tile-stats')
					.removeClass('animated fadeOut hidden')
					.addClass('animated fadeIn');
				$('.algorithm-match .tile-stats, .algorithm-evolutionary .tile-stats')
					.removeClass('animated fadeIn')
					.addClass('animated fadeOut');
			} else if (this.value == 'evolutionary')  {
				$('.algorithm-evolutionary .tile-stats')
					.removeClass('animated fadeOut hidden')
					.addClass('animated fadeIn');
				$('.algorithm-beat .tile-stats, .algorithm-match .tile-stats')
					.removeClass('animated fadeIn')
					.addClass('animated fadeOut');
			} else {
